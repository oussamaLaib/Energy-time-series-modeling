...
def prepareInputs(daydata, season, previousHours, previousDay, previousWeek, temp, tempMax, tempMin,dayIndicator):
    nbrInputs= 0
...
def getWinterForecastingResults(learninginputs,learningoutputs,testinputs,testoutputs,tempMLPmodels, tempErrorHistory, nbrInputs, IsShift,previoushour):
